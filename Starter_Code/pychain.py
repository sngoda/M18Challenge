...
def setup():
    ...
    #rec = Record(sender="Sender", receiver="Receiver", amount=0.0)
    return PyChain([Block(Record(), 0)])
...
# YOUR CODE HERE
input_sender = st.text_input("Sender Data")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
input_receiver = st.text_input("Receiver Data")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
input_value = st.text_input("Amount")

if (input_value==''):
    input_amount = 0.0
else:
    input_amount = float(input_value)

input_record = Record(sender=input_sender, receiver=input_receiver, amount=input_amount)
